...
def joinFactors(factors: List[Factor]):
    ...
    for factor in factors:
        ...
        if variable_domains_dict is None:
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        new_unconditioned_vars = set(factor.unconditionedVariables()) - {eliminationVariable}
        new_conditioned_vars = set(factor.conditionedVariables())
        ...
        for old_assignment in factor.getAllPossibleAssignmentDicts():
            new_assignment = {var: val for var, val in old_assignment.items() if var != eliminationVariable}
            prob_sum = new_factor.getProbability(new_assignment) + factor.getProbability(old_assignment)
            new_factor.setProbability(new_assignment, prob_sum)
